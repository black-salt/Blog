      ...
      <div class="register-form">
        ...
        <div class="register-form-body">
          <el-form ref="registerForm" :model="registerForm" :rules="registerRules" label-width="80px" class="form-container">
            ...
            <el-button type="primary" class="w100" @click="submit('registerForm')" :loading="registerStatus">注 册</el-button>
            <p class="toLogin">
...
export default {
  ...
  methods: {
    ...
    uploadImage (e) {
      ...
      const file_suffix = temArr[temArr.length - 1]
      if (
        file_suffix !== 'jpg' &&
        file_suffix !== 'png' &&
        file_suffix !== 'jpeg'
    ...
    async handleRegister () {
      ...
      const { avatar, username, nickname, password } = this.registerForm
