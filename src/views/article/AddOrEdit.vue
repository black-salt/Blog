<template>
  <div>
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="article-form">
      ...
      <el-form-item>
        <el-button v-if="articleId==='0'" type="primary" @click="handleAddArticle('ruleForm')">提交</el-button>
        <el-button v-if="articleId!=='0'" type="primary" @click="handleUpdateArticle('ruleForm')">编辑</el-button>
