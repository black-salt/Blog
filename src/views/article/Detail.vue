<template>
  <div>
    ...
    <el-row>
      ...
      <el-col :span="6">
        <div class="nav">
          <div v-for="item in navList" :key="item.title" :class="{indent2: item.level===2, indent3: item.level===3, indent4: item.level===4}">
            <el-link :href="'#'+item.title">{{item.title}}</el-link>
          </div>
        </div>
      </el-col>
    </el-row>
